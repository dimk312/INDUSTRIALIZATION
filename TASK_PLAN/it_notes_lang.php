...
if (isset($_POST['SAVE_EDIT'])){
    $SUBJECT = mysqli_real_escape_string($mylink['link'], $_POST['SUBJECT']);  //Экранируем спецсимволы
$NOTE = mysqli_real_escape_string($mylink['link'], $_POST['NOTE']);  //Экранируем спецсимволы
$sql_up="UPDATE enterprise.task_note SET LANG_STATUS = 'U',  SUBJECT = '".$SUBJECT."', NOTE = '".$NOTE ."', USER_M = '".$_SESSION['logged_user']."' 
